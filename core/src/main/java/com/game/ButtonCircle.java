...
public abstract class ButtonCircle extends Button {
    ...
    public void update(PlayScene play) {
        ...
        if (!play.buttonChannels[channel]) {
            play.buttonChannels[channel] = isBeingPressed(play);
        }
    }
